 ...
 * 3. Select the script "PasteImageFromClipboard_Extension.cs" in the file dialog and open
...
/// <summary>
/// Extension to add clipboard image functionality to EPLAN editor
/// </summary>
public class PasteImageFromClipboardExtension
{
    #region Constants
